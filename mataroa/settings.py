"""
Django settings for BōcPress project.
...
EMAIL_HOST_BROADCASTS = ""
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER")
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD")
EMAIL_PORT = 587

EMAIL_FROM_HOST = CANONICAL_HOST
DEFAULT_FROM_EMAIL = f"BōcPress <admin@{EMAIL_FROM_HOST}>"
NOTIFICATIONS_FROM_EMAIL = f"BōcPress Notifications <notifications@{EMAIL_FROM_HOST}>"
SERVER_EMAIL = f"BōcPress Support <server@{EMAIL_FROM_HOST}>"
EMAIL_SUBJECT_PREFIX = "[BōcPress Notification] "
